...
public class HeuristicTC extends HeuristicMO {
	...
	protected ObjectiveFunction buildHeuristicFunction(FeatureModel fmodel, ObjectiveFunction objectiveFunction,
		...
		if (objectiveFunction instanceof AggregateObjective) {
			heuristicFunction = new HeuristicTC_AggregateObjective(fmodel, (AggregateObjective) objectiveFunction,
					optCriterion);
		} else {
			if (objectiveFunction instanceof MultiLinearPolynomialObjective)
				heuristicFunction = new HeuristicTC_MultiLinearPolynomialObjective(fmodel,
