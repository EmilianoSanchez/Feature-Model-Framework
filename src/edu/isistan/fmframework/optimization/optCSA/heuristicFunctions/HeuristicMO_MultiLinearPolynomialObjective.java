...
public class HeuristicMO_MultiLinearPolynomialObjective implements ObjectiveFunction {
	...
	public HeuristicMO_MultiLinearPolynomialObjective(FeatureModel fmodel,
			MultiLinearPolynomialObjective objectiveFunction, AggregateFunction optCriterion) {
		this.fmodel = fmodel;
		this.heuristicForLinearTerms = new HeuristicMO_AggregateObjective(fmodel,
