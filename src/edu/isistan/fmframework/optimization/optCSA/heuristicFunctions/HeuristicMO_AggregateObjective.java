...
public class HeuristicMO_AggregateObjective implements ObjectiveFunction {
	...
	public HeuristicMO_AggregateObjective(FeatureModel fmodel, AggregateObjective aggregateObjective,
